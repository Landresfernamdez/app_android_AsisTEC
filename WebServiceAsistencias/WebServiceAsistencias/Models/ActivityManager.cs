...
namespace WebServiceAsistencias.Models
{
    public class ActivityManager
    {
        ...
        public List<Evento> ObtenerEvento(string id)
        {
            ...
            string sql = "SELECT e.nombre_ev,e.id_ev,e.lugar,e.detalle,e.duracion,e.fecha,e.horario,e.horaI,e.horaF,e.CUPO,e.fechaStart from Evento as e where e.id_ev=@idevent";
